...
footer_pattern = re.compile(
    r"(Horizon Europe\s*-\s*)?Work Programme 2025 Culture, Creativity and Inclusive Society Part 5\s*-\s*Page \d+ of \d+",
    re.IGNORECASE
)
...
if __name__ == "__main__":
    clean_expected_and_scope_fields(
        json_path_in="routes/pipeline/output_files/enhanced_raw_cl2_call_blocks.json",
        json_path_out="routes/pipeline/output_files/enhanced_raw_cl2_call_blocks_cleaned.json"
    )
