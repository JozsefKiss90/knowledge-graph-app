...
//
// Note it scans STATIC copy — render the surface with stub/empty data. Real EuroSciVoc field names
// ("cryptography", "demography", "geographic information systems") legitimately contain the string.

const BANNED = /graph/i;
