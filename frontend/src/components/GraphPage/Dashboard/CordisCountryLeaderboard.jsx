...
const TOP_N = 10;
const ORGS_COLOR = "var(--d2-accent)"; // organisations active (presence) — Signal Blue, daylight-adaptive
const AREAS_COLOR = "var(--d2-open)";  // research areas touched (breadth) — Awarded Green, daylight-adaptive
